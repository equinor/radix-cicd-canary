...
/* GetApplicationJobLogsOK describes a response with status code 200, with default header values.
...
/* GetApplicationJobLogsUnauthorized describes a response with status code 401, with default header values.
...
/* GetApplicationJobLogsNotFound describes a response with status code 404, with default header values.
