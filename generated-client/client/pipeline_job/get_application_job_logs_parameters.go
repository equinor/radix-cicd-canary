...
/* GetApplicationJobLogsParams contains all the parameters to send to the API endpoint
   for the get application job logs operation.
...
// WithDefaults hydrates default values in the get application job logs params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetApplicationJobLogsParams) WithDefaults() *GetApplicationJobLogsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get application job logs params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetApplicationJobLogsParams) SetDefaults() {
