...
// FailurePolicy FailurePolicy describes how failed job replicas influence the backoffLimit.
//
...
func (m *FailurePolicy) validateRules(formats strfmt.Registry) error {
...
// ContextValidate validate this failure policy based on the context it is used
func (m *FailurePolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FailurePolicy) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FailurePolicy) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FailurePolicy) UnmarshalBinary(b []byte) error {
	var res FailurePolicy
