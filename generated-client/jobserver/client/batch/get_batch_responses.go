...
func (o *GetBatchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 500:
		result := NewGetBatchInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /batches/{batchName}] getBatch", response, response.Code())
	}
}
...
func NewGetBatchInternalServerError() *GetBatchInternalServerError {
	return &GetBatchInternalServerError{}
}
...
func (o *GetBatchInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
