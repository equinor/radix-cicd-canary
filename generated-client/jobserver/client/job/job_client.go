...
type ClientService interface {
	...
	StopAllJobs(params *StopAllJobsParams, opts ...ClientOption) (*StopAllJobsOK, error)
...
/*
StopAllJobs stops all jobs
*/
func (a *Client) StopAllJobs(params *StopAllJobsParams, opts ...ClientOption) (*StopAllJobsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*StopAllJobsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
